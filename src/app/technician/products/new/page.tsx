  ...
  return (
    <main className="max-w-2xl mx-auto py-8 px-4 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      ...
      >
              ...
              {images.map((img, idx) => (
                <div key={idx} className="relative group">
                  <img
                    src={img}
                    alt={`Preview ${idx + 1}`}
                    className="w-full h-24 object-cover rounded-lg border border-gray-200 group-hover:opacity-80 transition"
                  />
        ...
        <button
          type="submit"
          className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-200 shadow-md hover:shadow-lg active:scale-95"
        >
          Add Product
        </button>
      </form>
