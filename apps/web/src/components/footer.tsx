    ...
    <footer className="border-t bg-background">
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              The marketplace for spare parts. Connect buyers and sellers of automotive, 
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2024 SparesX. All rights reserved.
          </p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link href="/social/twitter" className="text-muted-foreground hover:text-primary transition-colors">
              Twitter
            </Link>
            <Link href="/social/facebook" className="text-muted-foreground hover:text-primary transition-colors">
              Facebook
            </Link>
